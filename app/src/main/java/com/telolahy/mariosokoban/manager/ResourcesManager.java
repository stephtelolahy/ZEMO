...
public class ResourcesManager {
    ...
    private void loadMenuFonts() {
        ...
        gameTitleFont = FontFactory.createStrokeFromAsset(activity.getFontManager(), gameTitleFontTexture, activity.getAssets(), "font/font.ttf", 32, true, Color.argb(256 * 6 / 10, 255, 255, 255), 2, Color.TRANSPARENT);
        gameTitleFont.load();
    ...
    private void loadGameGraphics() {
        ...
        try {
            ...
            gameBoxTextureRegion = TextureRegionFactory.extractTiledFromTexture(gameBoxTexture, 16, 1);
            gameBoxTexture.load();
